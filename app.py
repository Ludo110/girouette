...
st.markdown("<style>.stApp { background-color: #5d7689 !important; } .plage-card { background-color: #e2dfd7; padding: 20px 10px; border-radius: 15px; text-align: center; width: 200px; height: 250px; margin: 10px auto; display: flex; flex-direction: column; justify-content: flex-start; align-items: center; box-shadow: 0 4px 6px rgba(0,0,0,0.1); } .card-title { width: 100%; color: #333; margin: 0 0 10px 0; font-size: 1.2em; } .card-text { width: 100%; color: #555; margin: 0 0 10px 0; font-size: 0.9em; } a::after { content: none !important; } [data-testid='column'] { display: flex; justify-content: center; }</style>", unsafe_allow_html=True)
