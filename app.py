...
# Bandeau météo en couleur Vert Sauge (#dde2c5)
st.html(f"""
<div style="display: flex; justify-content: flex-start; gap: 40px; align-items: center; 
            ...
            box-shadow: 0 4px 15px rgba(0, 0, 0, 0.05); border: 1px solid rgba(255,255,255,0.2);
    ...
    <div style="border-left: 1px solid rgba(69, 26, 3, 0.15); height: 25px;"></div>
    <div style="font-size: 16px; color: #7c2d12; font
