    ...
    for i in range(0, len(abritees), 3):
        ...
        for j in range(3):
            if i + j < len(abritees):
                ...
                with cols[j]:
                    st.html(f"""
                    <div style="background-color: #dde2c5; border-radius: 16px; padding: 20px;
...
# 5. GRILLE DES PLAGES EXPOSÉES (Fonds colorés en #dde2c5)
