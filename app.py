...
df["Protégée"] = df.apply(
    lambda row: est_abritee(row, wind_dir, wind_speed), axis=1
)
...
st.markdown(
    "<h3 style='color: #ffffff; font-family: sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.1);'>🟢 Plages à l'abri conseillées</h3>",
...
# 5. GRILLE DES PLAGES EXPOSÉES (Cadre blanc, bordure modifiée en #d2f3ee)
